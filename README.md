...
---
## Sample Results
**Prompt:** *A rusty bicycle in front of a barn*

**Generated image**
<br>
<img src="assets/generated_image.png" width="256">

Metadata is available in `assets/metadata.json`.

The heatmaps show where the model attends for different words. Attention for *bicycle* concentrates on the object in the scene, while *barn* activates around the structure.

### Word and Phrase Attention

| Word or Phrase | CLIP Heatmap | T5 Heatmap |
|----------------|--------------|------------|
...
By examining how attention evolves over diffusion steps, we can observe when different concepts emerge, and in which blocks.

<div align="center">
<img src="assets/clip/curves/words_mean_block14.png" width="600">
<p><em>Mean attention per word across diffusion steps, CLIP encoder (Block 14)</em></p>
</div>
