...
---
## Sample Results
Below is an analysis of the prompt: "A rusty bicycle in front of a barn"

Image generated by the prompt:
<img src="assets/generated_image.png" width="256">
Metadata can be viewed in assets/metadata.json

1. Spatial Attention (Heatmaps)
We can visualise exactly where the model focuses for specific words. Notice how the attention for "bicycle" is localised to the animal, while "barn" focuses on the surrounding structure.
